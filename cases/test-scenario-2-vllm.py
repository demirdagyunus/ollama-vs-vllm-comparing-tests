...
# Add the parent directory to Python path to import base classes
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from cases.base_performance_and_scalability_test import ResourceMonitor
...
def main():
    ...
    parser.add_argument("--levels", nargs="+", type=int, default=[2, 5],
